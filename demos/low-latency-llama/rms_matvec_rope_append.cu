...
template <typename Config, typename Globals> struct rms_qkv_rope_append {
    ...
    // Block boundaries in units of matvec_block_size:
    ...
    // RoPE scratch: head_dim floats cos + head_dim floats sin
    ...
    struct pipeline_specifics {
        ...
        store(megakernel::state<Config> &s, const Globals &g,
            ...
            // blocks per head = head_dim / matvec_block_size
            ...
            if (kittens::laneid() == 0) {
                ...
                // barrier: blocks per head = head_dim/matvec_block_size
                atomicAdd(
