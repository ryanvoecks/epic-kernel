...
#define LLAMA_3B_LM_HEAD_BLOCK_SIZE 16
...
struct globals_t {
    ...
    constexpr static int downproj_reduction_chunk_size = 1024;
    ...
    using weights_t =
        kittens::gl<kittens::bf16, 1, -1, -1, hidden_dim,
           kittens::st_bf<matvec_block_size, weight_tile_cols>>;
    ...
    // num_layers by ops by up to (Q_heads + K_heads + V_heads)
    using barriers =
