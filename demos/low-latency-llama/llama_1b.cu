...
PYBIND11_MODULE(mk_llama, m)
{
    ...
    kittens::py::bind_kernel<
        mk<default_config, llama_1b_globals, attention_partial_op, attention_reduction_op,
            rms_qkv_rope_append_op, downproj_op, o_proj_op, rms_upgate_silu_op, rms_lm_head_op>>(m,
        "mk_llama", &llama_1b_globals::Bar, &llama_1b_globals::instructions,
        ...
        &llama_1b_globals::down_weights, &llama_1b_globals::lm_head_norm_weights,
        &llama_1b_globals::lm_head_weights, &llama_1b_globals::k_cache, &llama_1b_globals::v_cache,
        ...
        &llama_1b_globals::pos_id, &llama_1b_globals::attn_scale, &llama_1b_globals::rms_norm_eps,
