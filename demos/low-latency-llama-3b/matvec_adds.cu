...
// (default). For downproj: _REDUCTION_DIM = 1024 (matvec_reduction_size).
...
struct MatVecAddOp {
    ...
    struct parsed_instruction {
        ...
        __device__ inline parsed_instruction(
            ...
            // For downproj: REDUCTION_DIM=1024, reduction_block_idx=0..7 → col=0..7168.
...
// downproj: reduces over intermediate_dim=8192 via col-splits of 1024.
// REDUCTION_DIM=1024 → STAGE_PAGES=2, INPUT_PIPELINE_STAGES=6.
// Each col-split of 1024 covers 1024/16 = 64 upgate blocks, so
// EXPECTED = 1024 / matvec_block_size = 64.
template <typename Config, typename Globals>
struct downproj : MatVecAddOp<
    1024 / Globals::matvec_block_size,  // 64
    ...
    1024  // matvec_reduction_size
> {};

// o_proj: reduces over hidden_dim=3072. REDUCTION_DIM=3072 (default).
// EXPECTED = num_attention_heads = 24
template <typename Config, typename Globals>
struct o_proj : MatVecAddOp<
    Globals::num_attention_heads,  // 24
